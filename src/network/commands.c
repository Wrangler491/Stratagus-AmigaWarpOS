...
//      02111-1307, USA.
//
//      $Id: commands.c,v 1.113 2004/06/24 18:07:53 jarod42 Exp $
...
static FullReplay* StartReplay(void)
{
	...
	replay->Comment3 = strdup("$Id: commands.c,v 1.113 2004/06/24 18:07:53 jarod42 Exp $");
...
void ParseExtendedCommand(unsigned char type, int status,
	unsigned char arg1, unsigned short arg2, unsigned short arg3,
	unsigned short arg4)void ParseExtendedCommand(unsigned char type, int status,
	unsigned char arg1, unsigned short arg2, unsigned short arg3,
	unsigned short arg4)
{
	// Note: destroyed units are handled by the action routines.
