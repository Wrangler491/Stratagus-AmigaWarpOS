...
//      02111-1307, USA.
//
//      $Id: network.h,v 1.54 2004/06/24 16:35:02 jarod42 Exp $
...
volatile struct dl_node
{
	struct dl_node* next;
	struct dl_node* prev;
};

volatile struct dl_head
{
...
static volatile struct dl_head*  //debugdebug inline
...
static volatile struct dl_node*
...
#define DL_LIST(id) volatile struct dl_head id[1] = {{ \
	(volatile struct dl_node *)&id[0].null, 0,\
	(volatile struct dl_node *)&id[0].first \
	}}
